...
@allure.feature('Комментарии к постам')
@allure.story('Создание комментария с текстом')
...
def test_check_creating_comment_on_cirillic(vk_api):
    ...
    with allure.step('Берем айдишник комментария'):
        comment = vk_api.wall_createComment(
            new_post_id,
            additional_params={'message': 'Текст кириллицей'}).json()
...
@allure.feature('Комментарии к постам')
@allure.story('Создание комментария с текстом')
@allure.title('Комментарий на латинице. В ответе возвращаетя айди созданного комментария')
...
@allure.feature('Комментарии к постам')
@allure.story('Создание комментария с картинкой')
@allure.title('Создание комментария с картинкой. В ответе возвращается айди созданного комментария')
def test_check_creating_comment_with_photo(vk_api):
    ...
    with allure.step('Создаем комментарий и берем его айдишник'):
        comment = vk_api.wall_createComment(
            new_post_id,
            additional_params={'attachments': 'photo5474852_457247884'}
        ).json()
    comment_id = comment['response']['comment_id']
    with allure.step('Проверка, что поле Id содержит значение айдишника комментария'):
        assert comment_id
...
@allure.feature('Комментарии к постам')
@allure.story('Создание комментария с картинкой')
@allure.title('Создание комментария с двумя картинками. В ответе возвращается айди созданного комментария')
def test_check_creating_comment_with_two_photos(vk_api):
    ...
    with allure.step('Создаем комментарий и берем его айдишник'):
        comment = vk_api.wall_createComment(
            new_post_id,
            additional_params={
            'attachments': 'photo5474852_457247884,photo5474852_457247821'}
        ).json()
    comment_id = comment['response']['comment_id']
    with allure.step('Проверка, что поле Id содержит значение айдишника комментария'):
        assert comment_id
...
@allure.feature('Комментарии к постам')
@allure.story('Создание комментария с видео')
@allure.title('Создание комментария с видео. В ответе возвращается айди созданного комментария')
...
@allure.feature('Комментарии к постам')
@allure.story('Создание комментария с видео.')
@allure.title('Проверка, что у созданного комментария тип аттачмента = "video"')
